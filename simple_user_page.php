...
$currentUser = $_GET['id'];
$sql = "SELECT id, f_name, l_name, pass_, role_id, photo FROM users WHERE id='$currentUser'";
...
<form action="simple_update_ex_user.php" method="POST" enctype="multipart/form-data">
    ...
    <a href="main.php" class="btn btn-default">Back</a>
</form>
